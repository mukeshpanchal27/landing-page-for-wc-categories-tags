...
class WC_Landing_Page_For_Category_Tag_Activator {
	...
	public static function activate() {
		if ( !class_exists( 'WooCommerce' ) ) {
			...
			$message = sprintf( 
				esc_html__( 'Sorry, but this plugin requires the WooCommerce Parent Plugin to be installed and active. %1$s&raquo; Return to Plugins.%2$s', 'wc-landing-page-for-category-tag' ),
