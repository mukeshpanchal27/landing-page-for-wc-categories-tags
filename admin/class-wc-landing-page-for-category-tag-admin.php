...
class WC_Landing_Page_For_Category_Tag_Admin {
	...
	public function enqueue_styles() {
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/wc-landing-page-for-category-tag-admin.css', array(), $this->version, 'all' );
	}
	...
	public function wc_lp_categories_tags_option_register() {
		...
		require_once plugin_dir_path( __FILE__ ).'partials/class-wc-landing-page-for-category-tag-description.php';		
		require_once plugin_dir_path( __FILE__ ).'partials/class-wc-landing-page-for-category-tag-category-description.php';
	...
	public function wc_lp_categories_tags_admin_menu_page() {
		add_menu_page( 
			__( 'WooCommerce Landing Page for Categories &amp; Tags Settings', 'wc-landing-page-for-category-tag' ),
			__( 'WC Landing Page for Categories &amp; Tags', 'wc-landing-page-for-category-tag' ),
			'manage_options',
	...
	public function wc_lp_categories_tags_callback() { ?>
		<div class="wrap wc-lp-wrapper">
			<h1><?php _e( 'WooCommerce Landing Page for Categories &amp; Tags Settings', 'wc-landing-page-for-category-tag' ); ?></h1>
			<form method="post" action="options.php">
				...
				<table class="form-table" role="presentation">
					<tbody>
						<tr>
							<td colspan="2"><h2><?php _e( 'Product Categories', 'wc-landing-page-for-category-tag' ); ?></h2></td>
						</tr>
						<tr>
							<td>
								...
								<label for="wc_lp_top_categories" class="wc_ld_label"><?php _e( 'Top Description', 'wc-landing-page-for-category-tag' ); ?></label>
							</td>
							<td>
								...
								<label for="wc_lp_bottom_categories" class="wc_ld_label"><?php _e( 'Bottom Description', 'wc-landing-page-for-category-tag' ); ?></label>
							</td>
						</tr>
					</tbody>
				</table>
				<table class="form-table" role="presentation">
					<tbody>
						<tr>
							<td colspan="2"><h2><?php _e( 'Product Tags', 'wc-landing-page-for-category-tag' ); ?></h2></td>
						</tr>
						<tr>
							<td>
								...
								<label for="wc_lp_top_tags" class="wc_ld_label"><?php _e( 'Top Description', 'wc-landing-page-for-category-tag' ); ?></label>
							</td>
							<td>
								...
								<label for="wc_lp_bottom_tags" class="wc_ld_label"><?php _e( 'Bottom Description', 'wc-landing-page-for-category-tag' ); ?></label>
							</td>
						</tr>
					</tbody>
				</table>
